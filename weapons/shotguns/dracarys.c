class RA_Dracarys_Base : RifleBoltLock_Base
{
	...
	override SprayPaintItemEntry GetSprayPaintTypes()
	{
		...
		m_SprayPaintEntry.Add(SprayPaintTypes.BLACK, "RA_Dracarys_Black");
		m_SprayPaintEntry.Add(SprayPaintTypes.TAN, "RA_Dracarys_Tan");
	...
	{	
		...
		if (RA_QDJK_ShotgunMuzzle.Cast(item))
		{
